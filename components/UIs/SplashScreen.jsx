...
export function SplashScreen({ onClose }) {
  return (
    <div
      ...
      aria-modal="true"
      aria-label="Welcome"
      className="fixed flex flex-col items-center justify-around inset-0 z-[9999] bg-black text-white md:hidden lg:hidden xl:hidden"
    >
      <div className="flex flex-col gap-2 items-center">
        <Image className="w-[65vw] object-center" src="/assets/splash/gridImage.png" width={1000} height={1000} alt="Company grid image"/>
        <Image className="w-[75vw] h-[20vh]" src="/assets/splash/splashLogo.png" width={2000} height={2000} alt="underline" />
      </div>

      <div>
        <p className="font-Angkor uppercase font-bold text-3xl">Create. <span className="text-amber-400">Sell.</span> Pay-Off</p>
      </div>
    
      <div className="w-[70vw]">
        <p className="font-inter text-center">By continuing, you agree to SLEM’s <span className="text-amber-400">Privacy Policy</span> and <span className="text-amber-400">Terms of Service</span></p>
        <button
          onClick={onClose}
